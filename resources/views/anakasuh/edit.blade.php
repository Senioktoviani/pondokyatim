...
@section('header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <div class="m-0">Edit Data Anak</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('anakasuh.update', $anak->id) }}" method="post">
                            @csrf
                            @method('put')
                            <div class="form-group">
                                <label for="">Masukan Nama Anak</label>
                                <input type="text" name="nama" value="{{ $anak->nama }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_lahir" value="{{ $anak->tgl_lahir }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pendidikan" value="{{ $anak->pendidikan }}"
